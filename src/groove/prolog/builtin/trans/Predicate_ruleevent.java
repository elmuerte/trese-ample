 ...
 */
public class Predicate_ruleevent extends TransPrologCode
{
	public Predicate_ruleevent()
	{}
	...
	public int execute(Interpreter interpreter, boolean backtrackMode, Term[] args) throws PrologException
	{
		...
		else
		{
			...
			Set<RuleEvent> events = ((GrooveEnvironment) interpreter.environment).getGrooveState().getRuleEvents();
			PrologCollectionIterator it = new PrologCollectionIterator(events, args[0], interpreter.getUndoPosition());
			return it.nextSolution(interpreter);
		}
	}
}
