...
public class Predicate_node_self_edges extends GraphPrologCode
{
	...
	public Predicate_node_self_edges()
	{}
	...
	protected int nextSolution(Interpreter interpreter, SelfEdgesBacktrackInfo bi) throws PrologException
	{
		while (bi.nodes.hasNext())
		{
			...
			{
				if (edge.opposite() == n && edge.source() == n)
				{
			...
			{
				Term lblList = CompoundTerm.getList(PrologUtils.createJOTlist(edgeLabels));
