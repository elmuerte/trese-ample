...
public class GftParser extends GftParserBase {
    ...
    // $ANTLR start "gft"
    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:34:1: gft : ( node )+ ( constraints ( constraint )+ )? ;
    public final void gft() throws RecognitionException {
        try {
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:38:2: ( ( node )+ ( constraints ( constraint )+ )? )
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:38:4: ( node )+ ( constraints ( constraint )+ )?
            {
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:38:4: ( node )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
            ...
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:38:10: ( constraints ( constraint )+ )?
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:38:11: constraints ( constraint )+
                    {
                    ...
                    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:38:23: ( constraint )+
                    int cnt2=0;
                    loop2:
                    do {
                        int alt2=2;
    ...
    // $ANTLR start "node"
    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:41:1: node : id= IDENTIFIER EQUALS ( MANDOPT name= STRING mand= nodeList opt= nodeList | OR name= STRING chld= nodeList | XOR name= STRING chld= nodeList ) ;
    public final void node() throws RecognitionException {
        ...
        try {
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:45:2: (id= IDENTIFIER EQUALS ( MANDOPT name= STRING mand= nodeList opt= nodeList | OR name= STRING chld= nodeList | XOR name= STRING chld= nodeList ) )
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:45:4: id= IDENTIFIER EQUALS ( MANDOPT name= STRING mand= nodeList opt= nodeList | OR name= STRING chld= nodeList | XOR name= STRING chld= nodeList )
            {
            id=(Token)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_node70); 
            match(input,EQUALS,FOLLOW_EQUALS_in_node72); 
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:46:2: ( MANDOPT name= STRING mand= nodeList opt= nodeList | OR name= STRING chld= nodeList | XOR name= STRING chld= nodeList )
            int alt4=3;
            switch ( input.LA(1) ) {
            case MANDOPT:
                {
            ...
            switch (alt4) {
                case 1 :
                    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:46:4: MANDOPT name= STRING mand= nodeList opt= nodeList
                    {
                    ...
                    break;
                case 2 :
                    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:48:4: OR name= STRING chld= nodeList
                    {
                    ...
                    break;
                case 3 :
                    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:50:4: XOR name= STRING chld= nodeList
                    {
    ...
    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:55:1: nodeList returns [List<String> ids = new ArrayList();] : LBRACK (id1= IDENTIFIER ( COMMA id2= IDENTIFIER )* )? RBRACK ;
    public final List<String> nodeList() throws RecognitionException {
        ...
        try {
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:59:2: ( LBRACK (id1= IDENTIFIER ( COMMA id2= IDENTIFIER )* )? RBRACK )
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:59:4: LBRACK (id1= IDENTIFIER ( COMMA id2= IDENTIFIER )* )? RBRACK
            {
            match(input,LBRACK,FOLLOW_LBRACK_in_nodeList149); 
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:60:2: (id1= IDENTIFIER ( COMMA id2= IDENTIFIER )* )?
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:60:3: id1= IDENTIFIER ( COMMA id2= IDENTIFIER )*
                    {
                    id1=(Token)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_nodeList156); 
                    ids.add((id1!=null?id1.getText():null));
                    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:61:3: ( COMMA id2= IDENTIFIER )*
                    loop5:
                    do {
                        int alt5=2;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:61:4: COMMA id2= IDENTIFIER
                    	    {
    ...
    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:65:1: constraints : CONSTRAINTS EQUALS clds= nodeList ;
    public final void constraints() throws RecognitionException {
        List<String> clds = null;


        try {
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:69:2: ( CONSTRAINTS EQUALS clds= nodeList )
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:69:4: CONSTRAINTS EQUALS clds= nodeList
            {
    ...
    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:73:1: constraint : id= IDENTIFIER EQUALS (req= REQUIRES | exl= EXCLUDES ) f1= STRING f2= STRING ;
    public final void constraint() throws RecognitionException {
        ...
        try {
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:80:2: (id= IDENTIFIER EQUALS (req= REQUIRES | exl= EXCLUDES ) f1= STRING f2= STRING )
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:80:4: id= IDENTIFIER EQUALS (req= REQUIRES | exl= EXCLUDES ) f1= STRING f2= STRING
            {
            id=(Token)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_constraint224); 
            match(input,EQUALS,FOLLOW_EQUALS_in_constraint226); 
            // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:80:25: (req= REQUIRES | exl= EXCLUDES )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:80:26: req= REQUIRES
                    {
                    ...
                    break;
                case 2 :
                    // C:\\local\\mhendrik_ample\\.workspace\\trese.featuremodel\\src\\trese\\featuremodels\\gft\\Gft.g:80:61: exl= EXCLUDES
                    {
