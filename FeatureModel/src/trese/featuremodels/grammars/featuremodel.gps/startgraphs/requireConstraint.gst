...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="requireConstraint" role="graph" edgeids="false" edgemode="directed">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n19229"/>
        ...
        <edge from="n19235" to="n19230">
            <attr name="label">
                <string>mandatory</string>
            </attr>
        </edge>
        <edge from="n19229" to="n19229">
            <attr name="label">
        ...
        <edge from="n19230" to="n19239">
            <attr name="label">
                <string>alt</string>
            </attr>
        </edge>
        <edge from="n19243" to="n19243">
            <attr name="label">
                <string>string:"D"</string>
            </attr>
        </edge>
        <edge from="n19236" to="n19242">
            <attr name="label">
                <string>requires</string>
            </attr>
        </edge>
        <edge from="n19240" to="n19240">
            <attr name="label">
        ...
        <edge from="n19235" to="n19232">
            <attr name="label">
                <string>optional</string>
            </attr>
        </edge>
        <edge from="n19230" to="n19236">
            <attr name="label">
                <string>alt</string>
            </attr>
        </edge>
        <edge from="n19232" to="n19237">
            <attr name="label">
                <string>or</string>
            </attr>
        </edge>
