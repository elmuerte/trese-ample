...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="twoRequireConstraintAlt" role="graph" edgeids="false" edgemode="directed">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n20297"/>
        ...
        <edge from="n20302" to="n20302">
            <attr name="label">
                <string>string:"C"</string>
            </attr>
        </edge>
        <edge from="n20309" to="n20301">
            <attr name="label">
                <string>or</string>
            </attr>
        </edge>
        ...
        <edge from="n20298" to="n20303">
            <attr name="label">
                <string>alt</string>
            </attr>
        </edge>
        <edge from="n20308" to="n20301">
            <attr name="label">
                <string>requires</string>
            </attr>
        </edge>
        ...
        <edge from="n20305" to="n20305">
            <attr name="label">
                <string>string:"G"</string>
            </attr>
        </edge>
        <edge from="n20298" to="n20300">
            <attr name="label">
                <string>alt</string>
            </attr>
        </edge>
        <edge from="n20310" to="n20310">
            <attr name="label">
                <string>string:"D"</string>
            </attr>
        </edge>
        <edge from="n20311" to="n20309">
            <attr name="label">
